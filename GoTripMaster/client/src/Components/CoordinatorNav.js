    ...
    <Navbar.Brand href="/">
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="d-flex" style={{fontSize:18,marginLeft:150}}>
          <Nav.Link href="/coordinatordashboard"><h5>Home</h5></Nav.Link>
          <Nav.Link href="/coordinatorpackages"><h5>Packages</h5></Nav.Link>
          <Nav.Link href="/coordinatorveiwpayment"><h5>Payment</h5></Nav.Link>
